  ...
  const handleUploadImage = async (e) => {
    ...
    if (file.size > 200 * 1024) {
      ...
      try {
        ...
        setMedicineDetails({ ...medicineDetails, uploadedImg: compressed });
        setPreview(URL.createObjectURL(compressed));
        toast.update(toastId, { render: "Image optimized!", type: "success", isLoading: false, autoClose: 2000 });
      } catch (err) {
        toast.update(toastId, { render: "Optimization failed, trying original...", type: "warning", isLoading: false, autoClose: 2000 });
