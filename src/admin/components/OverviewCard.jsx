    ...
    <>
      <div className="mt-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Link to={`/${path}`}>
            <div className="bg-gray-50 p-3 md:p-6 rounded-lg flex flex-col md:flex-row items-start space-x-4 border-4 border-gray-100 hover:shadow-lg transition-shadow cursor-pointer gap-2">
              <div className="bg-blue-200 text-blue-700 text-lg md:text-2xl p-4 rounded-lg">
                <FaPen />
              </div>
              <div>
                <h4 className="text-sm md:text-lg font-semibold text-gray-800 ">
