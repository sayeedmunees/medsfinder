      ...
      <header className="py-4 px-6 md:px-12 flex justify-between items-center bg-gray-100 shadow-sm">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="p-2 rounded-full text-2xl text-gray-800 hover:bg-gray-200 "
          >
            <FaRegCircleUser />
          </button>
        </div>
        {dropDownStatus && (
          <div
            className="absolute right-10 top-17 z-10 mt-2 w-46 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-hidden p-2 font-semibold "
            role="menu"
            aria-orientation=""
            tabIndex="-1"
          >
            <div role="none">
              ...
              <Link to={"/admin-dashboard"}>
                <p
                  class="flex gap-2 px-4 py-2 my-1 text-sm rounded-md  hover:bg-gray-200 text-gray-700"
                  role="menuItem"
                  tabIndex="-1"
                  id="menu-item-0"
                >
              ...
              <button
                type="submit"
                class="flex gap-2 w-full rounded-md px-4 py-2 text-left text-sm text-red-600 hover:bg-red-200"
                role="menuItem"
                tabIndex="-1"
                id="menu-item-1"
              >
